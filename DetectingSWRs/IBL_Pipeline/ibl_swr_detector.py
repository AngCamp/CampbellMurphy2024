...
#swr_output_dir = 'IBL_swr_changingpriors' # directory specifying the output
swr_output_dir = 'all_IBL_ca1_recordings' # directory specifying the output
...
data = np.load('all_ibl_sessions_with_ca1.npz')

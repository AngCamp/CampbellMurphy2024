...
def main():
    ...
    #all_sesh_with_ca1_eid = ['88224abb-5746-431f-9c17-17d7ef806e6a']
    #all_sesh_with_ca1_eid = [1125713722,1140102579,1119946360,1115086689,1152632711,1117148442,1128719842,1122903357,1124507277,1053718935,1124285719,1048189115,1139846596,1116941914,1125937457,1064415305,1065437523,1115368723,1123100019,1121607504,1115077618,1115356973,1152811536,1118508667,1121406444,1118324999,1130349290,1118512505,1128520325,1130113579,1120251466,1118327332]
    all_sesh_with_ca1_eid = [797828357,816200189,719161530,757216464,771990200,763673393,819186360,831882777,721123822,768515987]
